...
exports.seedPedidos = seedPedidos;
...
async function saveGroupOrder({ pedido, items, pagtos }) {
    const seedPedido = new ddb_repository_1.DDBRepository('cadastro-dev', ddb_utils_1.DDBClient.client());
