...
import { OrderGroup, Order, OrderItem, OrderPayment } from "./order.type";
...
async function saveGroupOrder({ order, items, payments }: OrderGroup) {
  const seedOrderRep = new DDBRepository("cadastro-dev", DDBClient.client());
